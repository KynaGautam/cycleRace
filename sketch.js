...
function preload(){
//load the animations,images,and sounds
...
function draw() {
  ...
  if(gameState===PLAY){
   ...
   // make the main cyclist move with the mouse
    mainCyclist.y = World.mouseY;
  
   //make the main cyclist collide with edges
  ...
  //making the oppsition cyclists come randomly
  ...
  //end the game if the main cyclist touches any other cyclist
